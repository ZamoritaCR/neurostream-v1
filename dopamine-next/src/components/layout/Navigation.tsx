    ...
    <header className="fixed top-0 left-0 right-0 z-40 hidden md:block">
      ...
      <div className="relative max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="ml-2 flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-primary-500 to-secondary-400 text-white font-semibold shadow-glow-sm hover:shadow-glow transition-shadow">
